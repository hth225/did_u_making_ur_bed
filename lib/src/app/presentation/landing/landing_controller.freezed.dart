...
mixin _$LandingState {
  bool get hasSeenLoading => throw _privateConstructorUsedError;
...
class _$LandingStateCopyWithImpl<$Res, $Val extends LandingState>
  ...
  @override
  $Res call({
    Object? hasSeenLoading = null,
  }) {
    return _then(_value.copyWith(
      hasSeenLoading: null == hasSeenLoading
          ? _value.hasSeenLoading
          : hasSeenLoading // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
}
...
class _$LandingStateImpl implements _LandingState {
  _$LandingStateImpl({this.hasSeenLoading = false});

  @override
  @JsonKey()
  final bool hasSeenLoading;

  @override
  String toString() {
    return 'LandingState(hasSeenLoading: $hasSeenLoading)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.hasSeenLoading, hasSeenLoading) ||
                other.hasSeenLoading == hasSeenLoading));
  }

  @override
  int get hashCode => Object.hash(runtimeType, hasSeenLoading);
...
abstract class _LandingState implements LandingState {
  factory _LandingState({final bool hasSeenLoading}) = _$LandingStateImpl;

  @override
  bool get hasSeenLoading;
  @override
  @JsonKey(ignore: true)
  _$$LandingStateImplCopyWith<_$LandingStateImpl> get copyWith =>
      throw _privateConstructorUsedError;
